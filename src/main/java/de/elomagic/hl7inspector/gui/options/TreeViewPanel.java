...
public class TreeViewPanel extends AbstractPanel {
     ...
     */
    public TreeViewPanel(PanelDialog d) {
        super(d);
    }
    ...
    public void init() {
        ...
        FormLayout layout = new FormLayout(
                ...
                "p, 3dlu, p, 3dlu, " + "p, 3dlu, p, 4dlu, " + "p, 3dlu, p, 7dlu, p, 3dlu, p, 3dlu, p");   // rows
    ...
    @Override
    public Icon getIcon() {
        return ResourceLoader.loadImageIcon("view_tree.png", ResourceLoader.LARGE_IMAGE);
    }
