...
public class ViewHexFile extends BasicAction {
    ...
    public void actionPerformed(final ActionEvent event) {
        if(StartupProperties.getInstance().getExternalHexViewer() == null) {
            Notification.info("No external hex viewer/editor set. Please check your configuration.");
        } else {
            ...
            if(selectedObjects.isEmpty()) {
                ...
                if(file == null) {
                    ...
                    try {
                        ...
                        Notification.error(ee, "Can't start external hex viewer/editor application.");
                    }
                }
            }
        }
