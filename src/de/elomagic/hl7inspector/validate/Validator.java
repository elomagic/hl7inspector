...
public class Validator {
    ...
    public Validator(Profile profile) { this.profile = profile; }
    
    private Profile profile;
    
    public ValidateStatus validate(Message message) throws Exception {
        Vector<ValidateStatus> statusList = validateObject(message);
    ...
    private Vector<ValidateStatus> validateObject(Hl7Object obj) {
        Vector<ValidateStatus> statusList = new Vector<ValidateStatus>();
        ...
        if (obj instanceof Message) {
            ...
            if (de == null) {
                ...
                Vector<ValidateStatus> childStatusList = validateDataType(obj, de.getDataType());                
    ...
    private Vector<ValidateStatus> validateDataType(Hl7Object obj, String dataType) {
        Vector<ValidateStatus> errorList = new Vector<ValidateStatus>();
    ...
    private ValidateStatus validateDataTypeDT(Hl7Object obj) {
        ...
        try {
            ...
            switch (len) {
                case 4: pat = "yyyy";  break;
                case 6: pat = "yyyyMM"; break;
                case 8: pat = "yyyyMMdd"; break;
                default: throw new Exception(ILLEGAL_DATA_TYPE_FORMAT_TEXT);
            }
    ...
    private ValidateStatus validateDataTypeDTM(Hl7Object obj) {
        ...
        try {
            ...
            switch (len) {
                ...
                case 6: pat = "yyyyMM"; break;
                case 8: pat = "yyyyMMdd"; break;
                case 10: pat = "yyyyMMddHH"; break;
                case 12: pat = "yyyyMMddHHmm"; break;
                case 14: pat = "yyyyMMddHHmmss"; break;
                case 16: pat = "yyyyMMddHHmmss.S"; break;
                case 17: pat = "yyyyMMddHHmmss.SS"; break;
                case 18: pat = "yyyyMMddHHmmss.SSS"; break;
                case 19: pat = "yyyyMMddHHmmss.SSSS"; break;
                default: throw new Exception(ILLEGAL_DATA_TYPE_FORMAT_TEXT);
            }
    ...
    private ValidateStatus validateDataTypeTM(Hl7Object obj) {
        ...
        try {                    
            ...
            switch (len) {
                case 2: pat = "HH"; break;
                case 4: pat = "HHmm"; break;
                case 6: pat = "HHmmss"; break;
                case 8: pat = "HHmmss.S"; break;
                case 9: pat = "HHmmss.SS"; break;
                case 10: pat = "HHmmss.SSS"; break;
                case 11: pat = "HHmmss.SSSS"; break;
                default: throw new Exception(ILLEGAL_DATA_TYPE_FORMAT_TEXT);
            }
