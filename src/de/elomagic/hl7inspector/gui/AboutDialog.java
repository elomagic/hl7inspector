...
public class AboutDialog extends BaseDialog {
    ...
    private void init() {
        ...
        try {
            lblContact = new LinkLabel("Contact: hl7inspector@elomagic.de", "mailto:hl7inspector@elomagic.de");
            lblWebsite = new LinkLabel("Forum: www.elomagic.de/forum", "http://www.elomagic.de/forum");
            lblForum = new LinkLabel("Web: www.elomagic.de", "http://www.elomagic.de");
        } catch (Exception ex) {
        ...
        FormLayout layout = new FormLayout(
                ...
                "p, 3dlu, p, 3dlu, p, 3dlu, p, 3dlu, p, 3dlu, p, 3dlu, p, 3dlu, p, p:grow");   // rows
        ...
        builder.add(lblWebsite, cc.xy(4, 11));

        builder.add(lblForum, cc.xy(4, 13));
...
//        builder.add(new JLabel(System.getProperty("java.version", "Unkown")),     cc.xy(3, 13));
        ...
        setSize(getPreferredSize().width, 320);
