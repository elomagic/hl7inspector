...
public class FramingPane extends JPanel {
    ...
    protected void init() {
        ...
        int c = Integer.parseInt(prop.getProperty(prop.DEFAULT_FRAME_START, "11"));
        cbbStartChar.setSelectedIndex(c);
        
        c = Integer.parseInt(prop.getProperty(prop.DEFAULT_FRAME_STOP1, "28"));
        cbbStopChar1.setSelectedIndex(c!=-1?c:32);

        c = Integer.parseInt(prop.getProperty(prop.DEFAULT_FRAME_STOP2, "13"));
