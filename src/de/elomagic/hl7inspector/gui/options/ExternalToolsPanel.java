...
public class ExternalToolsPanel extends AbstractPanel {
    ...
    public ExternalToolsPanel(PanelDialog d) { super(d); }
...
//            "8dlu, left:max(40dlu;p), 75dlu, 75dlu, 7dlu, right:p, 4dlu, 75dlu",
    ...
    public Icon getIcon() { return ResourceLoader.loadImageIcon("pref-external-tools.png", ResourceLoader.LARGE_IMAGE); }
    
    public String getTitle() { return "External Tools"; }
    
    public String getDescription() { return "External Tools"; }
