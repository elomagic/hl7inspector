...
public class FontsColorOptionPanel extends AbstractPanel {
    ...
    public FontsColorOptionPanel(PanelDialog d) { super(d); }

    public Icon getIcon() { return ResourceLoader.loadImageIcon("colorize.png", ResourceLoader.LARGE_IMAGE); }
    
    public String getTitle() { return "Color"; }
    
    public String getDescription() { return "Color Options"; }    
...
//        builder.addSeparator("Desktop",         cc.xyw(1,  1, 4));
    ...
    public void read() {
        ...
        lblNodeText.setForeground(p.getColor(p.COLOR_NODE_TEXT));
        lblColorNodePrefix.setForeground(p.getColor(p.COLOR_NODE_PREFIX));
        lblNodeDescription.setForeground(p.getColor(p.COLOR_NODE_DESCRIPTION));
        lblNodeTruncate.setForeground(p.getColor(p.COLOR_NODE_TRUNCATE));
    }
    ...
    public void write() {
        ...
        p.setColor(p.COLOR_NODE_TEXT, lblNodeText.getForeground());
        p.setColor(p.COLOR_NODE_PREFIX, lblColorNodePrefix.getForeground());
        p.setColor(p.COLOR_NODE_DESCRIPTION, lblNodeDescription.getForeground());
        p.setColor(p.COLOR_NODE_TRUNCATE, lblNodeTruncate.getForeground());        
    }           
    ...
    class ChangeColorAction extends AbstractAction {
        ...
        public void actionPerformed(java.awt.event.ActionEvent e) {
            ...
            Color c = dlg.showDialog(tf, "Choose color", tf.getForeground());
